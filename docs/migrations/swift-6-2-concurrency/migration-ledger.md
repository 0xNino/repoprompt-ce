...
- Migration remains lazy on the first runtime-owned mutation, retains exact rollback bytes/default values, and performs no startup rewrite. Validation did not launch or relaunch the visible app.
